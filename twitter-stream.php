	...
	<div style="width: 500px; margin-top:10px;">
    	<div style="border: 1px solid rgb(221, 221, 221); padding: 10px; float: left; background-color: white; margin-right: 15px;">
    		<div style="width: 350px; height: 130px; float:left;">
        		<h3>Donate</h3>
   				<p>If you like this plugin and have found it to be useful, please help me keep this plugin free by clicking the <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=N9Q2JG3DP4SNC" target="_blank"><strong>donate</strong></a> button. Thank you.</p>
				</div>
			<div style="width:100px; float:left; margin:15px 0 0 10px;">
				<a target="_blank" title="Donate" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=N9Q2JG3DP4SNC"><img src="<?php echo WP_PLUGIN_URL; ?>/twitter-stream/donate-paypal.jpg" alt="Donate with Paypal">	</a>
...
function twitter_stream($args = FALSE) {
	...
	$cache_path = '/tmp/'.$r['username'].'.cache'; //Set our cache path. Can be changed if you feel the need.
	...
	$output = preg_replace('~(\@[a-z0-9_äöüÄÖÜß]+)~uise', "'<span class=\"at-reply\"><a href=\"http://twitter.com/'.substr('$1', 1).'\" title=\"View '.substr('$1', 1).'\'s profile\">$1</a></span>'", $output);
	//Find all the #tags and place them in a span so CSS can be used to highlight them.
	$output = preg_replace('~(\#[a-z0-9_äöüÄÖÜß]+)~uise', "'<span class=\"hash-tag\"><a href=\"http://twitter.com/search?q='.urlencode('$1').'\" title=\"Search for $1 on Twitter\">$1</a></span>'", $output);
